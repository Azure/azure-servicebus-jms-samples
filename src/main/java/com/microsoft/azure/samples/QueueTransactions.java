...
public class QueueTransactions {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("Sent " + count + " messages in " + taken + "ms and rolled back");
            ...
            System.out.println("Sent " + count + " messages in " + taken + "ms and committed");
            ...
            int timeout = 1000;
            for (int i = 1; i <= count*2; i++, actualCount++) {
            ...
            System.out.println("Received " + actualCount + " messages in " + taken + "ms and rolled back");
            ...
            System.out.println("Received " + actualCount + " messages in " + taken + "ms and committed");
